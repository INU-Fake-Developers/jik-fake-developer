/**
 * 성명서, 본 항목은 여러분이 기술 및 오락만을 배울 수 있도록 도와줄 뿐이며, 절대 개정된 사이트의 대규모 전파 및 상용화를 방지하여,
 * 특허 침해를 방지할 수 있도록 하지 않을 것입니다.！
 */
...
let adLink = 'https://github.com/jhg3410';

// 웹 페이지 제목 수정: "합성 큰 수박"을 바꿉니다.
document.getElementsByTagName("title")[0].innerText = '프로그래밍 언어 합치기';
